...
uses libeay32, SysUtils, Windows, OpenSSLUtils, libeay32plus;
  ...
  type
    ...
    TTipoDigestionOpenSSL = (tdMD5, tdSHA1, tdSHA256);
    ...
    private
        ...
        ///</summary>
        function BinToBase64(const PDat: PBYTE; const DatLen: DWORD): WideString;
    ...
    public
        ...
        function HacerDigestion(ArchivoLlavePrivada, ClaveLlavePrivada: String; sCadena: TCadenaUTF8;
                 trTipo: TTipoDigestionOpenSSL) : WideString;
...
// Usuario: axesys
function TOpenSSL.BinToBase64(const PDat: PBYTE; const DatLen: DWORD): widestring;
