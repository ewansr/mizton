...
Var
  ...
  Rango: Variant;
  zMat: TZQuery;
  iniFila, iniCol, recFila, recCol: Integer;
  ...
  try
    ...
    begin
      ...
      try
        ...
        SetBorders(ExApp.Range[ColumnaNombre(IniCol) + IntToStr(IniFila) + ':' + ColumnaNombre(IniCol + recCol) + IntToStr(1)], xlContinuous, xlThin);
        ...
        Rango := ExApp.Range[ColumnaNombre(IniCol + 1) + IntToStr(IniFila) + ':' + ColumnaNombre(6 + zUMateriales.RecordCount) + IntToStr(IniFila + recFila)];
